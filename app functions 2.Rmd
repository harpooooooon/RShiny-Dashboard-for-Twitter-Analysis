...
authentication <- function(x){
  consumer_key = "w0PM5CNfcQFnCPLUkibZh2FAy"
  consumer_secret = "H92iQUKMhmZAJ0dCva0dS9hrceewadWn3JyLMkfWvZ213S8GbH"
  access_token = "798399916158676992-Sf9JRWL7iwibWpQVgfsfneVWo6Sexmj"
  access_secret = "8aWOMUhIqpnOzVbGTp0TwfBdN7CJvNUdMpUqRgZWijtWS"
